...
export const metadata: Metadata = {
  title: "Cetak Penjualan Unit",
};

type UnitSalePrintPageProps = {
  params: Promise<{ id: string }>;
};

const toNumber = (value: unknown) => Number(value ?? 0);

export default async function UnitSalePrintPage({ params }: UnitSalePrintPageProps) {
  await requirePageAccess("penjualan_unit", "print");
  ...
  return (
    <UnitSalePrintDocument
      backHref="/penjualan-unit/penjualan"
      title="Penjualan Unit"
      subtitle="Dokumen ringkasan penjualan dan laba rugi unit."
      report={{
